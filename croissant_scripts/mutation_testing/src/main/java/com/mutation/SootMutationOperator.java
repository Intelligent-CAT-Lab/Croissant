...
public abstract class SootMutationOperator implements MutationOperator {
    ...
    public SootMethod createIncrementstateSetterCounterMethod(SootField counterField) {
        SootMethod incrementstateSetterCounterMethod = this.createMethod("incrementstateSetterCounter", new ArrayList<>(), null, new ArrayList<>());
    ...
    public SootMethod makestateSetterTest(SootMethod stateSetterTest) {
        ...
        AssignStmt counterLocalInit = Jimple.v().newAssignStmt(counterLocal, counterFieldRef);
