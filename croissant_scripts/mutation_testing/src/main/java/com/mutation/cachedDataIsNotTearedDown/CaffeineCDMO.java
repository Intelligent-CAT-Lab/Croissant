...
public class CaffeineCDMO extends CacheDataMutationOperator {
    ...
    protected void addBrittleStatement(SootMethod test) {
        ...
        SootMethod assertNotNullSootMethod = this.getAssertNotNull();
        StaticInvokeExpr assertNotNullInvoke = Jimple.v().newStaticInvokeExpr(assertNotNullSootMethod.makeRef(), cachedObject);
        InvokeStmt assertNotNullStmt = Jimple.v().newInvokeStmt(assertNotNullInvoke);

        this.InsertStmtEnd(test, assertNotNullStmt);
    }
    ...
    public SootMethod createstateSetterTest(int stateSetterTestIndex) {
        SootMethod stateSetterTest = this.createTestMethod("c_stateSetter" + stateSetterTestIndex + "__CacheDataMutationOperator" );
        ...
        return this.makestateSetterTest(stateSetterTest);
    }
