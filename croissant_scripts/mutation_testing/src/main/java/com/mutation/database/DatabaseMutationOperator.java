...
public class DatabaseMutationOperator extends SootMutationOperator {
    ...
    private SootMethod createstateSetterTest(int stateSetterTestNumber) {
        ...
        SootMethod polluterTest = this.createTestMethod("c_stateSetterTest" +  stateSetterTestNumber + this.getCurrentMethodName());;
        ...
        return this.makestateSetterTest(polluterTest);
    ...
    private void createVictimTest() {
        ...
        SootMethod polluterTest = this.createTestMethod("b_VictimMutant" + this.getCurrentMethodName());;
        polluterTest.setActiveBody((Body) this.getCurrentMethod().getActiveBody().clone());
