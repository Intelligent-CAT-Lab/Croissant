...
public class newFileNullODMO extends SootMutationOperator {
    ...
    private SootMethod createVictimTest() {
        ...
        SootMethod victimTest = this.createTestMethod("b_victim_NewFileNull_" + this.getCurrentMethod().getName());
    ...
    public SootMethod createPolluterTest() {
        // virtualinvoke r1.<java.io.File: boolean delete()>();
        SootMethod polluterTest = this.createTestMethod("a_polluter_NewFileNull_" + this.getCurrentMethod().getName());
    ...
    public SootMethod createstateSetterTest(int stateSetterTestNumber) {
        ...
        SootMethod stateSetterTest = this.createTestMethod("c_stateSetter"+stateSetterTestNumber+"_NewFileNull_" + this.getCurrentMethod().getName());
    ...
    public void mutateMethod() throws Exception { //FIXME
        SootMethod victimTest = this.createVictimTest();
        this.getCurrentClass().addMethod(victimTest); //FIXME

        SootMethod polluterTest = this.createPolluterTest();
        this.getCurrentClass().addMethod(polluterTest); //FIXME
