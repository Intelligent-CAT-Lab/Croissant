...
*/
    ...
    void createWhileLoopTest(int i) {

        SootMethod currentMethod = this.getCurrentClass().getMethod(this.originalMethod.getSubSignature());

        SootMethod whileLoopTest = new SootMethod(currentMethod.getName() + "whileLoop" + this.getClass().getSimpleName(), currentMethod.getParameterTypes(), currentMethod.getReturnType(), currentMethod.getModifiers(), currentMethod.getExceptions());
