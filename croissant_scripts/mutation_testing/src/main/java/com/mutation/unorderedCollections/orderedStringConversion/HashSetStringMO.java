 ...
 */
public class HashSetStringMO extends OrderedStringConversionMutationOperator {

    public HashSetStringMO() {
        super("java.util.LinkedHashSet", "java.util.HashSet");
        this.stringEditor = new StringEditor("[", "]", ", ");
    }

    @Override
    public String toString() {
        return "HashSet Unordered Collection Mutation Operator";
    }
}
