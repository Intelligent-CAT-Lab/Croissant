...
public class DetectionToolAdder {
    ...
    public DetectionToolAdder(String projectDir) {
        ...
        detectionTools.add(new DetectionTool("edu.illinois", "nondex-maven-plugin", "1.1.2", "nondex"));
        detectionTools.add(new DetectionTool("edu.illinois.cs", "idflakies-maven-plugin", "2.0.1-SNAPSHOT", "idflakies"));
