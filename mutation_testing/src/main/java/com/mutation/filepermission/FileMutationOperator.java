...
public abstract class FileMutationOperator extends SootMutationOperator {
    ...
    protected SootMethod createstateSetterTest(int stateSetterNumber) {
        return this.makestateSetterTest(setFilePermission(this.fileName, 1, "cleanerMutant" + stateSetterNumber + victimTest.getName()),stateSetterNumber);
        //return this.makestateSetterTest(setFilePermission(this.fileName, 1, "cleanerMutant" + stateSetterNumber + victimTest.getName()));
    }
    ...
    public SootMethod createVictimTest() {
        SootMethod victimTest = this.createTestMethod("CroissantMutant_OD_FPD_b_Victim");
