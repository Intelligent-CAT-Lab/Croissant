...
public class MapIVMO extends InstanceVariableMutationOperator{
    @Override
    ...
    protected boolean isFieldAppropriate(SootField field) {
        return field.getType().toString().contains("Map");
    }


    @Override
    public void initializeField(SootMethod test, SootField field) {
        Scene.v().forceResolve("java.util.HashMap", SootClass.SIGNATURES);
        this.initializeCollection(test, field,  "<java.util.HashMap: void <init>()>", "java.util.HashMap");
    }


    @Override
    public void wipeField(SootMethod test, Value rValue) {
        clearCollection(test, (Local) rValue, "java.util.Map", "void clear()");
        Local boolLocal = getIsEmpty(test, (Local) rValue, "java.util.Map", "boolean isEmpty()");
    ...
    public void insertToField(SootMethod test, Local rValue) {
        insertToCollection(test, rValue, "java.util.Map", "java.lang.Object put(java.lang.Object,java.lang.Object)");
        Local boolLocal = getDoesContain(test, rValue, "java.util.Map","boolean containsKey(java.lang.Object)");
