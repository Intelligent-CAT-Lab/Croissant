...
public class RaceConditionMutationOperator extends StringInjector {
    ...
    public void mutateMethod() throws Exception {
        ...
        String newTest = "@Test\n" +
            "public void CroissantMutant_NOD_RC_RaceConditionMutationOperator_NoTemplate() throws IOException {\n" +
        ...
        com.framework.OperatorSelector.MUTANT_TIME.put("CroissantMutant_NOD_RC_RaceConditionMutationOperator_NoTemplate()", endTime - startTime);
