...
//         ArrayRef jArrayRef = Jimple.v().newArrayRef(local, IntConstant.v(0));
//         AssignStmt assignStmt = Jimple.v().newAssignStmt(OriginalElement, jArrayRef);
...
//         this.InsertStmtEnd(assignStmt);
        ...
        ArrayRef jArrayRefNew = Jimple.v().newArrayRef(getMethodsAgain, IntConstant.v(0));
        ...
        Stmt asstStmt = insertAssert(local, NewElement);
    }
