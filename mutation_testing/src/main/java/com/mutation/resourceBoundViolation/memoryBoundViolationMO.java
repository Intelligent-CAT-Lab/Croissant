        ...
        getUnits().insertAfter(
            Jimple.v().newInvokeStmt(
                Jimple.v().newStaticInvokeExpr(
                    getAssert(LongType.v()).makeRef(), totalMemoryL
                    , memoryAfter) //change to compare with totalMemoryL
            ), memoryAfterStmt);

//        Local com = Jimple.v().newLocal("com",  BooleanType.v());
//        getJimpleBody().getLocals().add(com);
//        Expr comp = Jimple.v().newCmplExpr(memoryAfter,memoryBefore);
//        AssignStmt ascomp = Jimple.v().newAssignStmt(com,comp);
//        getUnits().insertAfter(ascomp,memoryAfterStmt);
//
//        getUnits().insertAfter(
//            Jimple.v().newInvokeStmt(
//                Jimple.v().newStaticInvokeExpr(getAssertTrue().makeRef(),com)
//            ),ascomp);
