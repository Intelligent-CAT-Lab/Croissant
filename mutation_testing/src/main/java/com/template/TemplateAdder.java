...
public abstract class TemplateAdder {
    ...
    protected void addDependencyScope(String groupIdVal, String artifactIdVal, String artifactVersion, String scopeVal, String identifier) {
        this.pomModifier.addDependencyScope(groupIdVal, artifactIdVal, artifactVersion, scopeVal, identifier);
    }
